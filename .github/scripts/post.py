...
def cook_content(information):
    ...
    message = message + \
        ...
        "▫️ " + bold("Download: ", "<a href=\"https://www.pling.com/p/1288955\">Sourceforge</a>" + " | " + "<a href=\"https://github.com/SuperiorOS-Devices/official_devices/releases/tag/" + str(GithubReleasesTag) + "\">Github</a>") + "\n" + \
        "▫️ " + bold("Changelog: ", "<a href=\"https://raw.githubusercontent.com/SuperiorOS-Devices/changelogs/twelve/changelogs.txt\">Source</a>" + " | " + "<a href=\"https://raw.githubusercontent.com/SuperiorOS-Devices/changelogs/twelve/twelve_" + str(information['device']) + ".txt\"> Device</a>") + "\n" + \
